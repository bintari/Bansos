                        ...
                        <div class="col-sm-12">
                            ...
                            <table class="table table-bordered dataTable no-footer" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td><?php echo $a->iddatabansos; ?></td>
                                            <td><?php echo $a->nama; ?></td>
                                            <td><?php echo $a->nik; ?></td>
                                            <td><?php echo $a->kk; ?></td>
                                            <td><?= ($a->verif_desa == 1) ? "Tervalidasi Desa" : "Belum Tervalidasi Desa"; ?></td>
                                            <td><?= ($a->verif_kecamatan == 1) ? "Tervalidasi Kecamatan" : "Belum Tervalidasi Kecamatan"; ?></td>
                                            <td><?= ($a->verif_kabupaten == 1) ? "Tervalidasi Kabupaten" : "Belum Tervalidasi Kabupaten"; ?></td>
                                            </td>
                                            <td>
                                                <a href="<?= base_url('desa/validasi/') . $a->iddatabansos ?>" class="badge badge-warning">Validiasi</a>
                                            </td>
                                            <td>
                                                <a href="<?= base_url('desa/detail/') . $a->iddatabansos ?>" class="badge badge-warning">Detail</a>
                                                <a href="<?= base_url('kabupaten/edit/') . $a->iddatabansos ?>" class="badge badge-warning">Edit</a>
                                                <a href="<?= base_url('kabupaten/hapus/') . $a->iddatabansos ?>" class="badge warning">Hapus</a>
                                            </td>
                                        </tr>
                                        </tr>
                                    <?php
