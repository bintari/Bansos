                    ...
                    <div class="col-lg-10">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select class="custom-select" id="agama" name="agama">
                                    <option value="<?= $databansos['agama'] ?>"><?= $agamaval['agama'] ?>
                                    </option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="text" class="form-control" id="nofasilitas" name="nofasilitas" value="<?= $databansos['nofasilitas'] ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row justify-content-end">
                            <div class="col-sm-10">
                                <button type="submit" href= "<?= base_url($editt)?>" class="btn btn-primary">Edit</button>
                            </div>
                        </div>
    </form>
</div>
