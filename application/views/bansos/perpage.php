                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><a href="<?= base_url('laporan/trecking/') . $a->iddatabansos ?>" class="badge badge-warning">Detail</a>
                                            <a href="<?= base_url('laporan/edit/') . $a->iddatabansos ?>" class="badge badge-warning">Edit</a>
                                            <a href="<?= base_url('laporan/hapus/') . $a->iddatabansos ?>" class="badge warning">Hapus</a></td>
                                    </tr>
                                    </tr>
                                <?php
                                };
