<div class="container-fluid">
    <form action="<?= base_url() ?>pantauan/tambahinteraksi" method="POST">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="col-sm-10">
                    ...
                    <input type="text" id="nama_keluar" name="nama_keluar" value="<?php echo set_value('nama'); ?>" class="form-control">
                </div>
